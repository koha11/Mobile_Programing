import 'package:anhkhoa_flutter_app/rss/controller/rss_controller.dart';
import 'package:anhkhoa_flutter_app/rss/model/rss_item.dart';
import 'package:anhkhoa_flutter_app/rss/pages/page_url.dart';
                ...
                child: Column(
                  children: [
                    UserAccountsDrawerHeader(
                        ...
                        accountName: Text("Anh Khoa"),
                        accountEmail: Text("khoa.ta.64cntt@ntu.edu.vn")),
                    Text("Chọn nguồn báo"),
                    Divider(),
                    RadioListTile(
